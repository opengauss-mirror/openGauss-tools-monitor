...
public class NagiosServiceImpl {
    ...
    private static final String START_CLIENT = "%s/bin/nrpe -c %s/etc/nrpe.cfg -d"; // 重启客户端

    private static final String CAT_NRPE = "cat %s/etc/nrpe.cfg"; // 查看客户端配置文件内容

    private static final String LS_SH = "cd %s/libexec/&&ls"; // 查看客户端配置sh脚本
    ...
    private static final String WRITE_SH = "cd %s/libexec/&&echo \"%s\" > %s.sh"; // 覆盖

    private static final String START_HTTPD = "systemctl restart httpd"; // 重启服务端

    private static final String START_NAGIOS = "systemctl restart nagios"; // 重启服务端

    private static final String CAT_SERVICES = "cat %s/etc/objects/services.cfg"; // 查看服务端配置文件内容

    private static final String CAT_COMMANDS = "cat %s/etc/objects/commands.cfg"; // 查看服务端配置文件内容

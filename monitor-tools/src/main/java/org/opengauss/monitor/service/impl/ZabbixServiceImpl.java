...
import org.opengauss.monitor.entity.zabbix.WholeIds;
import org.opengauss.monitor.entity.zabbix.ZabbbixMap;
import org.opengauss.monitor.entity.zabbix.ZabbixMessge;
import org.opengauss.monitor.entity.zabbix.ZabbixSql;
...
public class ZabbixServiceImpl {
    ...
    public ZabbixMessge insertNecessary(String name, String ip, String port) {
        ...
        DataSource dataSource = commonService.getDataSource(); // zabbxis数据库
        // 判断主机是否添加
